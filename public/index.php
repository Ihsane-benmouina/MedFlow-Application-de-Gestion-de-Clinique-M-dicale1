...
switch ($action) {
    ...
    case 'admin_creer_medecin':
        ...
        break;
    case 'admin_creer_specialite':
        $adminController->creerSpecialite();
        break;
    case 'admin_modifier_specialite':
        $adminController->modifierSpecialite();
        break;

    case 'admin_supprimer_specialite':
        $adminController->supprimerSpecialite();
        break;
